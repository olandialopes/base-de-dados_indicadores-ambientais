...
result5.to_csv('analise descritiva/3-tabela_cnae_ano_estado_media_quant_consumida_energia_acordo_tipo.csv', index=False)
result6.to_csv('analise descritiva/3-tabela_cnae_ano_estado_media_quant_consumida_energia_acordo_tipo.csv', index=False)
#-------------------------------------------------------------------------------------------
...
result2 = data.groupby(['ano', 'estado', 'mun', 'clas_cnae20'])['quant_efluentes_liquidos'].mean().reset_index()
result3 = data.groupby(['ano', 'estado', 'mun', 'clas_cnae20'])['quant_efluentes_liquidos'].mean().reset_index()
result4 = data.groupby(['ano', 'estado', 'mun', 'clas_cnae20'])['quant_efluentes_liquidos'].mean().reset_index()
result5 = data.groupby(['ano', 'estado', 'mun', 'clas_cnae20'])['quant_efluentes_liquidos'].mean().reset_index()
result6 = data.groupby(['ano', 'estado', 'mun', 'clas_cnae20'])['quant_efluentes_liquidos'].mean().reset_index()
#Salvar o resultado em um arquivo CSV
result1.to_csv('analise descritiva/4-tabela_cnae_ano_municipio_media_quant_efluentes_liquidos.csv', index=False)
result2.to_csv('analise descritiva/4-tabela_cnae_ano_municipio_media_quant_efluentes_liquidos.csv', index=False)
result3.to_csv('analise descritiva/4-tabela_cnae_ano_municipio_media_quant_efluentes_liquidos.csv', index=False)
result4.to_csv('analise descritiva/4-tabela_cnae_ano_municipio_media_quant_efluentes_liquidos.csv', index=False)
result5.to_csv('analise descritiva/4-tabela_cnae_ano_municipio_media_quant_efluentes_liquidos.csv', index=False)
result6.to_csv('analise descritiva/4-tabela_cnae_ano_municipio_media_quant_efluentes_liquidos.csv', index=False)
#-------------------------------------------------------------------------------------------
data = pd.concat(b.values(), ignore_index=True)
